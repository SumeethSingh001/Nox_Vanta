...
CREATE TABLE `client_contacts` (
  ...
  `client_cont_phone` text,
  `client_cont_mobile` text,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `purchase_invoices` (
  ...
  `discount_type` int(11) DEFAULT 1 COMMENT '1 for percentage 0 for cash amount',
  `discount_inv` mediumtext ,
  `warehouse_id` bigint(20) UNSIGNED DEFAULT NULL,
  `shipping_expense` decimal(8,2) ,
  `shipping_expense_inv` mediumtext ,
  `total_inv` mediumtext ,
  `down_payment` decimal(8,2) ,
  `down_payment_type` int(11) DEFAULT 1 COMMENT '1 for percentage 0 for cash amount',
  `down_payment_inv` mediumtext ,
  `due_amount` mediumtext ,
  ...
  `paid_to_supplier_inv` mediumtext ,
  `due_amount_after_paid` mediumtext ,
  `payments_total` decimal(12,2) ,
  `due_amount_after_payments` decimal(12,2) ,
  `notes` text,
...
CREATE TABLE `purchase_invoice_taxes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `purchase_invoice_id` bigint(20) UNSIGNED NOT NULL,
  `total_tax_inv` mediumtext NOT NULL ,
  `total_tax_inv_sum` mediumtext NOT NULL ,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `warehouse_totals` (
  ...
  `warehouse_id` bigint(20) UNSIGNED NOT NULL,
  `product_id` bigint(20) UNSIGNED NOT NULL,
  `total_quantity_purchased` decimal(12,2) NOT NULL ,
  `total_purchases_cost` decimal(12,2) NOT NULL ,
  `total_sales_value_of_purchases` decimal(12,2) NOT NULL ,
  `expected_profit` decimal(12,2) NOT NULL ,
  `total_quantity_sold` decimal(12,2) NOT NULL ,
  `total_sold_cost` decimal(12,2) NOT NULL ,
  `total_value_of_sales` decimal(12,2) NOT NULL ,
  `actual_profit` decimal(12,2) NOT NULL ,
  `weighted_average_cost` decimal(12,2) NOT NULL ,
  `total_quantity_remain` decimal(12,2) NOT NULL ,
  `total_remain_cost` decimal(12,2) NOT NULL ,
  `total_sales_value_of_remain` decimal(12,2) NOT NULL ,
  `expected_profit_of_remain` decimal(12,2) NOT NULL ,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
